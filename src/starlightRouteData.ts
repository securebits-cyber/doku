...
const OG_IMAGE_ALT: Record<Lang, string> = {
	de: 'SentryMail Dokumentation – Phishing-Awareness, selbst gehostet',
	en: 'SentryMail documentation – phishing awareness, self-hosted',
};

const HOME_NAME: Record<Lang, string> = {
	de: 'SentryMail Dokumentation',
	en: 'SentryMail Documentation',
};
